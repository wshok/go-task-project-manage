        ...
        index: function () {
            ...
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'admin.username', minWidth: 80, title: '用户', search: false},
                    ...
                    {field: 'status', minWidth: 80, title: '状态', search: 'select', selectList:{0:"关",1:"开"},templet: ea.table.switch, sort:true},
                ]],
            });
